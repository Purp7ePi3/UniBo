...
class MyCircularArray {
    ...
    //Cambiando la dimensione dell'array posso stampare tutti i numeri senza che venga sovrascritti, non è affatto male :) good to know
    public static void main(final String[] args) {

        // 1) Creare un array circolare di dieci elementi
        MyCircularArray circularArray = new MyCircularArray(15);
