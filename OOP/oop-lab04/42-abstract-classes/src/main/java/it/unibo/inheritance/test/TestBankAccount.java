...
public class TestBankAccount {
    ...
    public static void main(final String[] args) {
        ...
        final AccountHolder aVerdi = new AccountHolder("Andrea", "Verdi",3);
        final AccountHolder atozzi = new AccountHolder("Aldo", "tozzi", 4);
        /*
         * Change the two accounts to verify that the behaviour of restricted and simple bank account are preserved
         */
        final BankAccount restricted = new ExtendedStrictBankAccount(atozzi, 0);
        ...
        final BankAccount classicBankAccount = new ClassicBankAccount(aVerdi,0);
        requireAccountsToWorkTheSameWay(restricted, extendedStrict); //Questo va dio cane
